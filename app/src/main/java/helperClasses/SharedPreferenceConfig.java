...
public class SharedPreferenceConfig {
    ...
    public SharedPreferenceConfig(Context context) {
        //constructor that sets initializes the sharedPreference object
    ...
    public void writeUsernamePref(String name)
    //method writes the username to shared preferences
    {
    ...
    public String readUserNamePref()
        //method used to get the username from shared preferences
    {
        String username ="";
